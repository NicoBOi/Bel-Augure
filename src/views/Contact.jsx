...
export default function Contact() {
  ...
  return (
    ...
    >
      ...
      <h2 className="mt-10 font-display text-[clamp(1.6rem,4vw,3.6rem)] leading-[1.2] text-encre">
      ...
      <p
        className="reveal-up mt-8 text-[12px] font-light tracking-[0.1em] text-grege"
        style={{ '--d': '0.5s' }}
      >
