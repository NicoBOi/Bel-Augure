...
const TIERS = [
  {
    ...
    includes: [
      '1 film 45-60 s',
      '1 jour de tournage, 1 lieu',
      '2 formats (16:9 + 9:16)',
      'Fond musical licencié',
      '2 allers-retours inclus',
    ],
    meta: 'Livraison 4 semaines',
    tone: 'light',
  },
  {
    name: 'Signature',
    ...
    includes: [
      '1 film 90-120 s',
      'Direction artistique + repérages',
      "2 jours de tournage, jusqu'à 2 lieux",
      '3 formats (16:9, 9:16, 1:1)',
      'Design sonore + fond musical licencié',
      '2 allers-retours inclus',
    ],
    meta: 'Livraison 6 semaines',
    tone: 'gold',
  },
  {
    name: 'Héritage',
    ...
    includes: [
      '1 film 2-3 min, écriture narrative (script + storyboard)',
      "3 jours de tournage, jusqu'à 3 lieux",
      'Étalonnage cinéma',
      '5 formats (réseaux + master 4K cinéma)',
      'Design sonore + fond musical licencié',
      '2 allers-retours inclus',
    ],
    meta: 'Livraison 8 semaines',
    tone: 'dark',
  },
  {
    name: 'Saisons',
    ...
    includes: [
      '4 films courts (15-30 s), 1 par saison',
      '1 tournage léger par saison (demi-journée, 1 lieu)',
      '2 formats par film',
      'Design sonore immersif, sans musique (parti pris)',
      '1 aller-retour par film',
    ],
  ...
  },
  {
    ...
    includes: [
      'Campagnes multi-films',
      'Formats longs',
      'Productions avec casting et décors',
      'Droits paid media étendus',
    ],
    meta: 'Sur devis',
    tone: 'dashed',
  },
