...
const OFFRES = [
  {
    ...
    detail: 'Deux journées de tournage. Livré en six semaines. À partir de 12 000 €, prix ferme au devis.',
    bgColor: 'rgb(217 198 166 / 0.45)',
    ink: false,
  },
  {
    name: 'Saisons',
    eyebrow: "L'année entière",
    desc: 'Votre lieu ne vit pas pareil en février et en août. Un film par saison, et chaque mois du contenu prêt à diffuser. Votre image suit le rythme de la maison sans que vous ayez à y penser.',
    detail: 'Quatre films par an, du contenu chaque mois. À partir de 16 000 €.',
    bgColor: '#6e6350',
    ink: true,
  },
  {
    name: 'Sur Mesure',
    eyebrow: 'Hors cadre',
    desc: "Pour ce qui déborde du cadre. Un soin signature à filmer en une journée, ou une campagne d'ouverture à écrire de zéro. On en parle, on cadre, et le devis qui suit est ferme.",
    detail: 'Sur devis.',
    bgColor: '#1a1512',
    ink: true,
  },
...
const QUESTIONS = [
  {
    q: 'Combien ça coûte ?',
    r: 'Signature démarre à 12 000 €, Saisons à 16 000 € pour l’année. Chaque lieu est différent, alors on précise ensemble. Le devis qui suit est ferme.',
  },
  {
    q: 'Qu’attendez-vous de nous ?',
    r: 'Pas grand-chose. Un échange au début, quelqu’un qui nous ouvre les portes, et votre établissement reste ouvert.',
  },
  {
