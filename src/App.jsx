...
const DESCRIPTIONS = {
  ...
  offres:
    'Trois façons de travailler ensemble : Film Signature (dès 5 500 € HT), Histoires de marque (dès 3 500 € HT, ou 3 000 € HT par mois sur douze mois) et Campagne (dès 15 000 € HT). Droits de diffusion offerts à vie.',
  contact:
