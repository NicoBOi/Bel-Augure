...
const DESCRIPTIONS = {
  ...
  offres:
    'Deux façons de travailler avec Bel Augure : Histoires, trois récits narratifs courts dès 3 900 € HT, ou Film, une histoire plus ample dès 6 900 € HT. Campagnes et collaborations dans la durée.',
  contact:
