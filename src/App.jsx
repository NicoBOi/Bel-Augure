...
const DESCRIPTIONS = {
  ...
  studio:
    "Bel Augure, studio de production fondé à Bordeaux par Nicolas Sempéré et Corentin Crestia : des films de marque pour l'hôtellerie et le bien-être haut de gamme.",
  offres:
