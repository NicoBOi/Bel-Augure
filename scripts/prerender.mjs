...
const ROUTES = [
  ...
  },
  {
    ...
    desc: 'Trois façons de travailler ensemble : Film Signature, le film fondateur ; Histoires de marque, un programme de récits courts ; Campagne Sensorielle, un déploiement complet sur mesure. Diffusion deux ans France incluse. Proposition détaillée après un échange de trente minutes.',
    h1: 'Offres — films pour hôtel, spa et maison de bien-être',
    body: `
      <h2>Film Signature</h2>
      <p>Le film qui installe durablement votre univers. Une pièce centrale, écrite et réalisée autour de ce que votre maison fait ressentir, conçue pour durer : votre site, vos présentations, vos salons, vos réseaux. Ce que vous recevez : un film de marque de 60 à 90 secondes réalisé sur mesure et ses versions 30 et 15 secondes, conception, écriture, direction artistique, repérage, deux jours de tournage dans votre lieu, montage, création sonore et étalonnage réalisés au studio, musique licenciée incluse. Livraison deux semaines après le dernier jour de tournage, deux allers-retours de validation inclus, diffusion incluse deux ans en France sur le digital et les réseaux sociaux. Extensions possibles : déclinaisons verticales, voix off, musique originale, images aériennes, journée de tournage supplémentaire, diffusion télévision, affichage, cinéma, internationale ou durée étendue. Une proposition détaillée est adressée après un échange de trente minutes.</p>
